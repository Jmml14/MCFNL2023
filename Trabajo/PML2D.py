...
class FDTD_PML2D():
    ...
    Esta clase construye las matrices de las conductividades sigma_x y sigma_y. Por otro lado, contruye 
    dos métodos para actualizar los campos eléctrico y magnético teniendo en cuenta que es necesario 
    usar un doble paso.

    """
    def __init__(self, L=10, w=porcentaje, CFL=1.0, N=101):
    ...
    def update_h(self):
        ...
        # Actualizamos con doble paso Hz
